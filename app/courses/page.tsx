...
const projects = [
    {
        ...
        category: "01",
        description: "Cutting-edge technology courses to prepare students for the digital future. Hands-on learning with modern tools and platforms.",
        sessions: [
    ...
    },
    {
        ...
        category: "02",
        description: "Develop strong mathematical foundations and problem-solving skills through innovative teaching methods.",
        sessions: [
            "ABACUS",
            "VEDIC MATHS",
            "GEOMETRY IN ARTS",
    ...
    },
    {
        ...
        category: "03",
        description: "Promote mental and physical well-being through strategic games and mindfulness practices.",
        sessions: [
            "CHESS",
            "CARROM",
            "YOGA & MEDITATION"
    ...
    },
    {
        ...
        category: "04",
        description: "Explore creative passions and develop artistic skills for personal growth and enjoyment.",
        sessions: [
            "DRAWING",
            ...
            >
                ...
                <div className="flex flex-col lg:flex-row h-full gap-8 lg:gap-12 mt-4">
                    ...
                    <div className="w-full lg:w-2/5">
                        ...
                        {/* Sessions List */}
                        <div className="mb-6">
                            <h3 className="text-lg font-semibold text-foreground mb-3">Available Sessions:</h3>
                            <div className="grid grid-cols-1 gap-2 max-h-40 overflow-y-auto">
                                {sessions.map((session, index) => (
                                    <div
                                        key={index}
                                        className={`flex items-center gap-2 p-2 rounded-lg transition-all cursor-pointer ${index === currentImageIndex
                                            ? 'bg-foreground/10 border border-foreground/30'
                                            : 'hover:bg-foreground/5'
                                            }`}
                                        onClick={() => setCurrentImageIndex(index)}
                                    >
                                        <div className={`w-2 h-2 rounded-full ${index === currentImageIndex ? 'bg-foreground' : 'bg-foreground/30'
                                            }`} />
                                        <span className="text-sm text-foreground/80">{session}</span>
                                    </div>
                                ))}
                            </div>
                        </div>
                    ...
                    <div className="w-full lg:w-3/5 h-64 lg:h-96 relative rounded-lg overflow-hidden border border-foreground/20">
                        ...
                        >
                            ...
                            <div className="absolute inset-0 bg-gradient-to-r from-background/0 via-background/10 to-background/30" />
                        </motion.div>
                    </div>
                </div>
        ...
        <section id="courses" className="w-full bg-background">
            ...
            <div className="container mx-auto px-2">
                ...
                <div className="text-center mb-4"> {/* Reduced from mb-16 to mb-4 */}
                    <h2 className="font-bowlby text-4xl md:text-5xl lg:text-6xl font-normal text-foreground mt-32 mb-2"> {/* Reduced from mb-4 to mb-2 */}
