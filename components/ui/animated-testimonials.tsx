...
export const AnimatedTestimonials = ({
  ...
  // Pre-defined rotations to ensure consistency between server and client
  const predefinedRotations = [-7, 10, -1, -4, 3, -2, 5, -8, 6, -9];
  ...
  // Get consistent rotation for each index
            ...
            <div className="relative h-80 w-full">
              ...
              {testimonials.map((testimonial, index) => (
                <div
                  ...
                  style={{
                    opacity: index === 0 ? 1 : 0,
                    transform: `scale(${index === 0 ? 1 : 0.95}) rotate(${getRotation(index)}deg)`,
